	...
	return (
		<div className='flex w-screen h-screen bg-[#2E3440]'>
			{started ? (
				...
				<button
					className='transition-colors m-auto px-20 py-44 text-white bg-[#5E81AC] border-2 border-[#5E81AC] rounded-full hover:bg-[#81A1C1]'
					onClick={() => toggleStarted(true)}
				>
					<div className='uppercase text-8xl'>SHABU</div>
					<div className='text-xl'>Salamat Hesus At Biyernes Ulit</div>
				</button>
			)}
		</div>
	);
